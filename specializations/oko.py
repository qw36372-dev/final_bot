"""
specializations/oko.py: Хэндлеры для Организация управления и контроля теста.
...
async def select_oko(callback: CallbackQuery, state: FSMContext):
    """Выбор специализации Организация управления и контроля → запрос ФИО."""
    await callback.message.edit_text(
        "📡 <b>Организация управления и контроля</b>\n\nВведите ваше ФИО:"
    )
